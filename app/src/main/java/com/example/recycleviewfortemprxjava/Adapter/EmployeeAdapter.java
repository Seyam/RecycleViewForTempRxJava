package com.example.recycleviewfortemprxjava.Adapter;
...
public class EmployeeAdapter extends RecyclerView.Adapter<EmployeeAdapter.EmployeeViewHolder> {
    ...
    private ArrayList<TempSensorData> dataList;
    private Context context;

    public EmployeeAdapter(ArrayList<TempSensorData> dataList, Context context) {
    ...
    public void onBindViewHolder(EmployeeViewHolder holder, final int position) {
        ...
        holder.txtEmpEmail.setText(dataList.get(position).getTempValue().toString()+"°C");
